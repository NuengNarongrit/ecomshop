...
export default function ContactPage(){
    return(
        <section className='bg-gradient-to-r from-slate-50 to-slate-200 dark:bg-slate-800'>
            <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="mb-4">
                    <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                        ...
                        <p className='mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400'>In hac habitasse plateadictumst</p>
                    </div>
                </div>
                <div className='flex items-stretch justify-center'>
                    <div className='grid md:grid-cols-2'>
                        <div className='h-full pr-6'>
                            <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Duis nec ipsum orci. Ut scelerisque
                                ...
                                <li className='flex'>
                                    <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            strokeLinejoin="round" class="h-6 w-6">

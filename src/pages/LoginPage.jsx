...
export default function LoginPage(){
    ...
    return(
        <section className={`m-20 flex items-center justify-center`}>{/* min-h-screen  back-img ${loaded ? 'loaded' : ''} */}
            {/* <!-- login container --> */}
            <div className="text-white bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-4 items-center">{/* bg-opacity-30 backdrop-filter backdrop-blur-lg */}
                {/* <!-- form --> */}
                <div className="md:w-1/2 px-8 md:px-16">
                    ...
                    <form action="" class="flex flex-col gap-4">
                        ...
                        <button class="bg-[#9f1239] rounded-xl text-white py-2 hover:scale-105 duration-300">Login</button>
                    </form>
